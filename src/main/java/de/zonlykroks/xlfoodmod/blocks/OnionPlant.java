...
public class OnionPlant extends CropBlock {
    ...
    public OnionPlant() {
        ...
        Registry.register(Registries.ITEM, new Identifier(XLFoodMod.MODID, "onion"), new AliasedBlockItem(this, new Item.Settings()));
    }
