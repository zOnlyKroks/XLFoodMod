...
public class LemonPlant extends CropBlock {
    ...
    public LemonPlant() {
        ...
        Registry.register(Registries.ITEM, new Identifier(XLFoodMod.MODID, "lemon_seeds"), new AliasedBlockItem(this, new Item.Settings()));
    }
